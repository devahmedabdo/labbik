...
const { createUser, getAllUsers, deleteUser, updateUser } = require("../controllers/admin/userAdminController");
...
const { getAllIssues, deleteIssue, deleteBulkIssues, updateIssue } = require("../controllers/admin/issueAdminController");
...
// 📌 Issues (with pagination/filtering)
router.get("/issues", getAllIssues);
router.delete("/issue/:id", deleteIssue);
router.patch("/issue/:id", updateIssue);
router.delete("/issues/bulk", deleteBulkIssues);
